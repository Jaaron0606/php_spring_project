...
<?php
    ...
    foreach ($people as $event) {
	   ...
	   //create short hand versions of current month 
        ...
        echo '<h1" align=center class="alert alert-info card">';
        echo "Today : ".date("F, d Y ",mktime(0,0,0,$month,$day,$year));
        echo '</h1>';
        echo '<table align="center" border="0" cellpadding=10 cellspacing=0 style=""><tr><td align=center>';
        echo '</td></tr></table>';
        echo '<div class = "card card-scaled">
        <table class ="card" align="center" border=1 cellpadding=10 cellspacing=0">
        <tr class = "bg-primary">
